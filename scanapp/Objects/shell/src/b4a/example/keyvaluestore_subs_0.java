...
try {
		Debug.PushSubsStack("Close (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,171);
...
try {
		Debug.PushSubsStack("ContainsKey (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,158);
...
try {
		Debug.PushSubsStack("CreateTable (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,177);
...
try {
		Debug.PushSubsStack("DeleteAll (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,164);
...
try {
		Debug.PushSubsStack("Get (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("GetBitmap (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,124);
...
_in.runVoidMethod ("InitializeFromBytesArray",(Object)(_b),(Object)(BA.numberCast(int.class, 0)),(Object)(_b.getField(true,"length")));
 BA.debugLineNum = 132;BA.debugLine="Dim bmp As Bitmap";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("GetDefault (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("GetMapAsync (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,36);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","91179671",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.runMethod(false,"getActivityBA"))),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Initialize (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,7);
...
try {
		Debug.PushSubsStack("ListKeys (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,146);
...
try {
		Debug.PushSubsStack("Put (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("PutBitmap (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,116);
...
try {
		Debug.PushSubsStack("PutMapAsync (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,70);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","91245192",RemoteObject.concat(RemoteObject.createImmutable("Failed to serialize object: "),_map.runMethod(false,"Get",(Object)((_key)))),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Remove (keyvaluestore) ","keyvaluestore",2,__ref.getField(false, "ba"),__ref,141);
